...
Ou installez avec Cargo : `cargo install dedupcommando` (le binaire est `dedcom`). La compilation depuis les sources se fait avec Docker, sans toolchain Rust local.
